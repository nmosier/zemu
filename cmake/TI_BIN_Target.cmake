# add 8xv, TI calc variable

function(add_8xv TARGET MAIN_SOURCE)
  ...
  if (DEFINED TI_UNPARSED_ARGUMENTS)
    message(FATAL_ERROR "add_8xv: invalid argument")
  endif()

  if(NOT DEFINED TI_NAME)
    get_filename_component(TI_NAME ${MAIN_SOURCE} NAME_WLE)
  endif()
  set(OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${TI_NAME}.8xv)
  ...
  if(DEFINED PLATFORM)
    ...
    elseif(PLATFORM STREQUAL "TI84PCE")
      ...
      message(FATAL_ERROR "add_8xv: unrecognized platform '${PLATFORM}'")
    endif()
  endif()
  ...
  add_custom_command(OUTPUT ${OUTPUT} ${LAB}
    COMMAND ${SPASM} ${TI_SPASM_FLAGS} ${TI_INCLUDE_DIRS} ${TI_DEFINITIONS} ${MAIN_SOURCE} ${OUTPUT}
  ...
  set_target_properties(${TARGET} PROPERTIES 8XV ${OUTPUT})
